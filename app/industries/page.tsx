...
const industries = [
  {
    ...
    img: '/ind-power.png',
    desc: 'Turnkey mechanical erection, rotary kiln installations, preheaters, clinker grinding units, and structural construction for greenfield plants, modernizations, and capacity expansions.',
    scope: ['Rotary kiln installations', 'Preheaters & clinker grinding units', 'Structural construction'],
  },
  {
    id: '02',
    name: 'Steel, Aluminium & Heavy Metals',
    img: '/ind-steel.png',
    desc: 'Structural steel fabrication, blast furnace erections, sponge iron plants, rebar mills, and heavy mill machinery positioning and alignment.',
  ...
  },
  {
    ...
    desc: 'High-pressure process piping pre-fabrication, mobile service tower installations, cross-country pipelines, and specialized equipment erection under strict ASME/API guidelines.',
    scope: ['High-pressure process piping', 'Mobile service tower installations', 'Cross-country pipelines'],
  },
  {
    id: '04',
    name: 'Thermal Power & Captive Utilities',
    img: '/ind-power.png',
    desc: 'Comprehensive construction and mechanical installation for power generation facilities, boiler units, structural sheds, and industrial utility networks.',
    scope: ['Power generation facilities', 'Boiler units & structural sheds', 'Industrial utility networks'],
  },
  {
    id: '05',
  ...
  },
  {
    ...
    desc: 'Specialized vessel fabrication, digester dome construction, chemical storage units, and process equipment mechanical assembly.',
    scope: ['Specialized vessel fabrication', 'Digester dome construction', 'Chemical storage units'],
  },
];
